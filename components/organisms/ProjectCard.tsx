...
import { github } from '../atoms/icons'

const ProjectCard: FC<ProjectCardProps> = ({ imageUrl }) => {
  return (
    <div className="shadow-card">
      <div className="relative bg-cover mt-5 rounded-lg">
        <div className="flex flex-col p-5 mx-2">
          <h3 className="text-sm">Bet system app</h3>
          <p className="text-paragraph mt-5">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Error, sint aspernatur aut
          ...
          <div className="flex items-center justify-center mt-5">
            ...
            <Button color="primary" className="ml-7" text="Demo">
