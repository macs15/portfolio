  ...
  return (
    <section className="my-10 mx-2 lg:grid-cols-2 lg:grid lg:mx-20 xl:mx-auto xl:px-20 about-container">
      ...
      <div className="xl:ml-10">
        ...
        <p className="text-base text-paragraph mt-2">
          Like many developers I started out trying to create video games but it would be nothing
          more than a hobby that inspired me on my path as a developer and finally when I met web
